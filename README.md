...
Pre-release (Phase 1, closing). `docker compose up` starts a deployment from a clean checkout; it is still not something to point at a workspace you care about.
